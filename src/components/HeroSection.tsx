...
const HeroSection = () => {
  return (
    ...
    >
      ...
      {/* Gradient Overlay */}
      <div className="absolute inset-0 bg-blue-300/60"></div>
      ...
      <div className="container mx-auto px-4 text-center relative z-10">
        {/* Badge */}
        <div className="inline-flex items-center space-x-2 bg-yellow-300/60 text-white px-4 py-2 rounded-full text-sm font-black mb-8 border border-yellow-400">
        ...
        {/* Main Title */}
        <h1 className="font-display font-bold text-5xl md:text-7xl lg:text-8xl leading-tight mb-6 drop-shadow-sm">
          <span className="text-blue-800">MASTERCLASS</span>
          <br />
        ...
        {/* Key Info */}
        <div className="flex flex-wrap justify-center items-center gap-8 mb-12 text-gray-700">
